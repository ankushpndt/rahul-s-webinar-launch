...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-hero pt-6 sm:pt-8 pb-16 sm:pb-24">
      <div className="container px-4 sm:px-6">
        {/* Top Badge */}
        <div className="flex justify-center mb-6 sm:mb-8">
          <div className="inline-flex items-center bg-primary text-primary-foreground rounded-full px-5 sm:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg font-bold shadow-lg animate-pulse-slow">
          ...
          <div className="relative max-w-md mx-auto lg:max-w-none">
            <div className="relative rounded-2xl overflow-hidden shadow-soft">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-foreground/90 via-foreground/70 to-transparent p-4 sm:p-6">
                <h3 className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-primary-foreground mb-1">
                  Rahul Sharma – Founder of Qurbat
                </h3>
                <p className="text-primary-foreground/80 text-xs sm:text-sm">
                  (Multi-City Fashion Brand)
                </p>
                <p className="text-primary-foreground/70 text-xs mt-1 sm:mt-2">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {infoCards.map((card, index) => (
                <div
                  key={index}
                  className="bg-card rounded-xl p-3 sm:p-5 shadow-card border border-border flex items-start gap-2 sm:gap-4"
                >
            ...
            <a
              href="#register"
              className="block w-full bg-primary hover:bg-primary/90 text-primary-foreground text-center py-4 sm:py-5 rounded-xl font-bold text-lg sm:text-xl transition-all duration-300 shadow-soft hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
            >
